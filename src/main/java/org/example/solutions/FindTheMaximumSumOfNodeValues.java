 ...
 * nums[i] represents the value of the node numbered i. Alice wants the sum of values of tree nodes to be maximum, for
 * which Alice can perform the following operation any number of times (including zero) on the tree:
 *
